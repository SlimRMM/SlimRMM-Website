      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="card p-8 mb-16 bg-gray-50">
          ...
          <div class="grid sm:grid-cols-3 gap-6">
            <div class="flex items-center justify-between p-4 bg-white rounded-lg">
              ...
              <span class="font-semibold text-gray-900">+150€/{{ t('pricing.perMonth').replace(' /', '') }}</span>
            </div>
            <div class="flex items-center justify-between p-4 bg-white rounded-lg">
              <span class="text-gray-700">{{ t('pricing.hosting.tier2') }}</span>
              <span class="font-semibold text-gray-900">+350€/{{ t('pricing.perMonth').replace(' /', '') }}</span>
            </div>
            <div class="flex items-center justify-between p-4 bg-white rounded-lg">
              <span class="text-gray-700">{{ t('pricing.hosting.tier3') }}</span>
              <span class="font-semibold text-gray-900">+500€/{{ t('pricing.perMonth').replace(' /', '') }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="mt-16 text-center">
          ...
          <div class="flex flex-wrap justify-center gap-4">
            <div
              v-for="(feature, index) in (t('pricing.features.list') as unknown as string[])"
              :key="index"
        ...
        <div class="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              ...
              <li><a href="#" class="hover:text-white transition-colors">{{ t('footer.links.careers') }}</a></li>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              ...
              <li><a href="#" class="hover:text-white transition-colors">{{ t('footer.links.imprint') }}</a></li>
            </ul>
          </div>
        </div>
